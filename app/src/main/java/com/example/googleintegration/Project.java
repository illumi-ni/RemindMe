...
//public class Project extends AppCompatActivity implements ProjectActivity, ProjectAdapter.OnProjectListener
...
//        adapter = new ProjectAdapter(options, this);
        ...
        adapter.setOnProjectListener(new ProjectAdapter.OnProjectListener() {
            @Override
            public void onProjectClick(View v, int position) {
//                ProjectList project = documentSnapshot.toObject(ProjectList.class);
                ...
                builder.setMessage("Are you sure you want to delete the project?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                adapter.deleteItem(position);
                                Toast.makeText(getApplicationContext(), "Project Deleted",
